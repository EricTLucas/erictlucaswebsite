...
<a class="navbar-brand" href="index.html">Eric Lucas </a>
...
<div class="collapse navbar-collapse " id="navbarSupportedContent">
  <ul class="navbar-nav ml-auto" id = "navbar-content">
   <li class="nav-item nav-item-hover"><a class="nav-link" href="#top">Home</a></li>
  ...
  <div class="p-4">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12 mb-4 mb-md-0 form-comtainer" id="contact">
          <div class="form-style-6">
             <div class="form-header">
                <h6 class="display">Get in Touch</h6>
              </div>
                <form name="form1" action="https://formcarry.com/s/TGTZjFS5IPH" method="POST" accept-charset="UTF-8" >
    ...
    <a class="social-button linkedin" href="https://linkedin.com/in/erictlucas" target="_blank" >
    ...
    <a class="social-button github" href="https://github.com/EricTLucas" target="_blank">
